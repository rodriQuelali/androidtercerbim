...
public class MainActivityDBlite extends AppCompatActivity {
    private EditText txtC, txtD, txtP;
    private Button btnR, btnCoCdi, btnCDes, btnEli, btnM;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_dblite);
        ...
        btnR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txtC.setText("");
                txtD.setText("");
                Toast.makeText(MainActivityDBlite.this, "Se registro Correctamente....", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnCoCdi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(fila.moveToFirst()){
                    ...
                    Toast.makeText(MainActivityDBlite.this, "NO se encontro Registro con el Codigo", Toast.LENGTH_SHORT).show();
                }
                bd.close();
            }
        });
        ...
        btnEli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txtP.setText("");
                if(cat == 1){
                    Toast.makeText(MainActivityDBlite.this, "El articulo fue eliminado correctamente", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(MainActivityDBlite.this, "No existe dicho articulo en el registro", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bd.close();
                if(cant == 1){
                    Toast.makeText(MainActivityDBlite.this, "Se edito correctamente", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(MainActivityDBlite.this, "Error, no se puedo editar los datos con dicho codigo!!!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
